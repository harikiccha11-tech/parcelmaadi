...
"[project]/src/app/api/admin/change-password/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    ...
    if (!newPassword || String(newPassword).length < 8) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
    ...
    const { verifyPassword } = await __turbopack_context__.A("[project]/src/lib/password.ts [app-route] (ecmascript, async loader)");
    if (admin.forcePasswordChange) {
        // first-time setup: currentPassword is the temp password
        if (!verifyPassword(currentPassword || "", admin.passwordHash)) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
    ...
    await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].adminUser.update({
        where: {
            id: admin.id
        },
        data: {
            passwordHash: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$password$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["hashPassword"])(newPassword),
    ...
    await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].adminActivity.create({
        data: {
            ...
            ip: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$rate$2d$limit$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getClientIp"])(req)
        }
    });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1fw6wgz._.js.map