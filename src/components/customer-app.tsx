      ...
      <section className="bg-brand-black text-white py-12">
        <div className="mx-auto max-w-6xl px-4">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              { icon: Package, title: "1. Choose Service", desc: "Pick from 12 services and see vehicle price cards." },
        ...
        <div className="grid md:grid-cols-2 gap-8 items-center">
          <div>
            ...
            <div className="mt-5 grid grid-cols-2 gap-3">
              <div className="rounded-xl bg-brand-yellow/20 border border-brand-yellow p-3"><div className="text-2xl font-extrabold text-brand-red">12+</div><div className="text-xs text-muted-foreground">Services</div></div>
